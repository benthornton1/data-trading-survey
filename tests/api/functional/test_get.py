...
from tests.helpers import (api_login, create_card, create_admin, create_participant, create_study, create_user_group, 
create_data_value_label, create_card_set, create_cards, create_response, create_heat_maps)
from app.api.helpers import create_card_json, create_card_set_json, create_data_value_label_json
...
def test_get_individual_response(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_response', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_responses(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        study_response_1 = create_response(client, creator=admin, participant=participant_1)
        study_response_2 = create_response(client, creator=admin, participant=participant_2)
        
        response = client.get(url_for('api.get_all_responses'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_participant(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_participant', id=2), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_participants(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_participants'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_user_group(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_user_group', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
        json = response.json
...
def test_get_all_user_groups(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_user_groups'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_indvidual_data_value_label(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_data_value_label', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_data_value_label(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_data_value_labels'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_study(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_study', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_studies(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_studies'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_heat_map(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = create_response(client, creator=admin, participant=participant, study=study)
        heat_maps = create_heat_maps(client, study=study, responses=[response], creator=admin)
        response = client.get(url_for('api.get_heat_map', id=heat_maps[0].id), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
        ...
        if heat_maps[0].data_value_label:
            assert json['data_value_label_id'] == heat_maps[0].data_value_label.id
        else:
...
def test_get_all_heat_maps(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        user_group = create_user_group(client, creator=admin, participants=[participant_1, participant_2])
        study = create_study(client, creator=admin, user_group=user_group)
        response_1 = create_response(client, creator=admin, participant=participant_1, study=study)
        response_2 = create_response(client, creator=admin, participant=participant_2, study=study)
        heat_maps = create_heat_maps(client, study=study, responses=[response_1, response_2], creator=admin)
        response = client.get(url_for('api.get_all_heat_maps'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_cards(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_card', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_cards(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_cards'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_individual_card_set(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_card_set', id=1), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
...
def test_get_all_card_sets(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('api.get_all_card_sets'), headers={"Authorization": "Bearer {}".format(access_token['access_token'])})
