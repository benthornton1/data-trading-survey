...
def test_get_study(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('study.study', id=study.id), follow_redirects=True)
        ...
        assert bytes(study.card_set_x.cards[0].description, 'utf-8') in response.data
        ...
        assert bytes(study.card_set_y.cards[0].description, 'utf-8') in response.data
...
def test_post_study(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        assert b'<p>Thanks for participating in the study, you can now log out of the system.</p>' in response.data
        ...
        response_db = Response.query.filter_by(participant_id=participant.id).first()
