...
def test_get_change_user_info(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.get(url_for('study.change_info'), follow_redirects=True)
...
def test_post_change_user_info(client, init_database):
    ...
    with client.application.test_request_context():
        ...
        response = client.post(url_for('study.change_info'), data=form.data, follow_redirects=False)
